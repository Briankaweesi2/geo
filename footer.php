...
<!-- footer-start -->
<footer>
    <?php if ( is_active_sidebar( 'footer-widgets1' ) || is_active_sidebar( 'footer-widgets2' ) || is_active_sidebar( 'footer-widgets3' ) || is_active_sidebar( 'footer-widgets3' ) ) { ?>
    ...
    <div class="copyright-text text-center">
        <div class="container">
            ...
            <?php } else { ?>
                <?php esc_html_e( 'Copyright &copy; 2020 by - Geoport', 'geoport' ); ?>
            <?php } ?>
            </p>
        </div>
    </div>
