  ...
  <div class="bpost-content b-details-content">
    ...
    <div class="details-content">
      <div class="bpost-meta mb-20">
        <ul>
          <li class="author"><i class="<?php echo esc_attr( $users ); ?>"></i><span><?php esc_html_e('By ', 'geoport'); ?></span><?php the_author_posts_link(); ?></li>
          <li><span><i class="<?php echo esc_attr( $calendar ); ?>"></i><?php echo esc_html ( get_the_date() ); ?></span></li>
          <li><span><i class="<?php echo esc_attr( $tax_cat ); ?>"></i><?php the_category(', '); ?></span></li>
          <li><a><i class="<?php echo esc_attr( $comments ); ?>"></i><?php comments_number( '0 Comments', '1 Comment', '% Comments' ); ?></a></li>
        </ul>
      </div>
