          ...
          <div class="bpost-meta mb-20">
            <ul>
              ...
              <?php }
                ...
                <li><a href="<?php the_permalink(); ?>"><i class="<?php echo esc_attr(  $calendar ); ?>"></i><?php comments_number( '0 Comments', '1 Comment', '% Comments' ); ?></a></li>
              <?php } if (!empty($blog_post_date)) { ?>
                <li><span><i class="<?php echo esc_attr( $comments ); ?>"></i><?php echo esc_html ( get_the_date() ); ?></span></li>
              <?php } ?>
            </ul>
          </div>
